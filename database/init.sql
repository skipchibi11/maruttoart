...
-- サンプルデータ
INSERT INTO materials (title, slug, description, search_keywords_en, search_keywords_jp, image_path, webp_path, upload_date) VALUES
('桃のイラスト', 'peach-illustration', '可愛らしい桃のイラストです。', 'peach,fruit,pink', 'もも,果物,ピンク', 'uploads/2024/08/peach.png', 'uploads/2024/08/peach.webp', '2024-08-12'),
