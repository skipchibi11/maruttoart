<?php
// 新しいindex.php - キャッシュバスティング版
// WordPress の古いキャッシュをバイパスするために一時的に使用
...
<head>
    ...
    <meta name="x-cache-bust" content="<?= time() ?>">
    <meta name="x-app-version" content="new-php-app">
...
<body>
    <!-- 新しいアプリケーションであることを示すバナー -->
    <div class="new-app-banner">
        ✅ 新しいPHPアプリケーションが正常に動作しています！（<?= date('Y-m-d H:i:s') ?>）
    </div>
