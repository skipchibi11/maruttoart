...
<nav class="navbar">
    <div class="container">
        ...
        <div class="tool-navigation">
            ...
            <a href="/compose2/index.php" class="tool-nav-link<?= $currentPage === 'index' ? ' active' : '' ?>" title="標準編集">
            ...
            <a href="/compose2/custom-size.php" class="tool-nav-link<?= $currentPage === 'custom-size' ? ' active' : '' ?>" title="カスタムサイズ編集">
